...
<table class="table tree widefat fixed gg_woo_feed-table-template" style="width: 100%;" id="gg_woo_feed-table-template">
    ...
    <tr>
        ...
        <td>
            <select name="mattributes[]" required class="gg_woo_feed-map-attributes">
				<?php print $dropdown->get_pinterest_attributes_dropdown( 'id' ); ?>
            </select>
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <select name="mattributes[]" required class="gg_woo_feed-map-attributes">
				<?php print $dropdown->get_pinterest_attributes_dropdown( 'title' ); ?>
            </select>
        </td>
        <td>
            <input type="text" name="prefix[]" autocomplete="off" class="gg_woo_feed-input">
    ...
    <tr>
        ...
        <td>
            <select name="mattributes[]" required class="gg_woo_feed-map-attributes">
				<?php print $dropdown->get_pinterest_attributes_dropdown( 'description' ); ?>
            </select>
        </td>
        <td>
            <input type="text" name="prefix[]" autocomplete="off" class="gg_woo_feed-input">
    ...
    <tr>
        ...
        <td>
            <select name="mattributes[]" required class="gg_woo_feed-map-attributes">
				<?php print $dropdown->get_pinterest_attributes_dropdown( 'item_group_id' ); ?>
            </select>
        </td>
        <td>
            <input type="text" name="prefix[]" autocomplete="off" class="gg_woo_feed-input">
    ...
    <tr>
        ...
        <td>
            <select name="mattributes[]" required class="gg_woo_feed-map-attributes">
				<?php print $dropdown->get_pinterest_attributes_dropdown( 'link' ); ?>
            </select>
        </td>
        <td>
            <input type="text" name="prefix[]" autocomplete="off" class="gg_woo_feed-input">
    ...
    <tr>
        ...
        <td>
            <select name="mattributes[]" required class="gg_woo_feed-map-attributes">
				<?php print $dropdown->get_pinterest_attributes_dropdown( 'product_type' ); ?>
            </select>
        </td>
        <td>
            <input type="text" name="prefix[]" autocomplete="off" class="gg_woo_feed-input">
    ...
    <tr>
        ...
        <td>
            <select name="mattributes[]" required class="gg_woo_feed-map-attributes">
				<?php print $dropdown->get_pinterest_attributes_dropdown( 'google_taxonomy' ); ?>
            </select>
        </td>
        <td>
            <input type="text" name="prefix[]" autocomplete="off" class="gg_woo_feed-input">
    ...
    <tr>
        ...
        <td>
            <select name="mattributes[]" required class="gg_woo_feed-map-attributes">
				<?php print $dropdown->get_pinterest_attributes_dropdown( 'image' ); ?>
            </select>
        </td>
        <td>
            <input type="text" name="prefix[]" autocomplete="off" class="gg_woo_feed-input">
    ...
    <tr>
        ...
        <td>
            <select name="mattributes[]" required class="gg_woo_feed-map-attributes">
				<?php print $dropdown->get_pinterest_attributes_dropdown( 'condition' ); ?>
            </select>
        </td>
        <td>
            <input type="text" name="prefix[]" autocomplete="off" class="gg_woo_feed-input">
    ...
    <tr>
        ...
        <td>
            <select name="mattributes[]" required class="gg_woo_feed-map-attributes">
				<?php print $dropdown->get_pinterest_attributes_dropdown( 'availability' ); ?>
            </select>
        </td>
        <td>
            <input type="text" name="prefix[]" autocomplete="off" class="gg_woo_feed-input">
    ...
    <tr>
        ...
        <td>
            <select name="mattributes[]" required class="gg_woo_feed-map-attributes">
				<?php print $dropdown->get_pinterest_attributes_dropdown( 'price' ); ?>
            </select>
        </td>
        <td>
            <input type="text" name="prefix[]" autocomplete="off" class="gg_woo_feed-input">
    ...
    <tr>
        ...
        <td>
            <select name="mattributes[]" required class="gg_woo_feed-map-attributes">
				<?php print $dropdown->get_pinterest_attributes_dropdown( 'sku' ); ?>
            </select>
        </td>
        <td>
            <input type="text" name="prefix[]" autocomplete="off" class="gg_woo_feed-input">
    ...
    <tr>
        ...
        <td>
            <select name="mattributes[]" required class="gg_woo_feed-map-attributes">
				<?php print $dropdown->get_pinterest_attributes_dropdown( 'brand' ); ?>
            </select>
        </td>
        <td>
            <input type="text" name="prefix[]" autocomplete="off" class="gg_woo_feed-input">
