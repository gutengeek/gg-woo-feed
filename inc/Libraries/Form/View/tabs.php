<?php
    ...
    <div class="js-gg_woo_feed-metabox-wrap gg_woo_feed-metabox-panel-wrap">
        <ul class="gg_woo_feed-form-data-tabs gg_woo_feed-metabox-tabs">
			...
			<?php if ( $this->has_sub_tab( $setting ) ) : ?>
				<?php if ( ! empty( $setting['sub-fields'] ) ) : ?>
					<?php foreach ( $setting['sub-fields'] as $index => $sub_fields ) : ?>
                        <div id="<?php echo $sub_fields['id']; ?>" class="panel gg_woo_feed_options_panel gg_woo_feed-hidden">
